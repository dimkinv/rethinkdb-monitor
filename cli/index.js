...
table.focus();
screen.render();
function initTables(dbName) {
    return __awaiter(this, void 0, void 0, function () {
        var tablesNames, data;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, rethink.getTables(dbName)];
                case 1:
                    tablesNames = _a.sent();
                    data = tablesNames.map(function (tableName) {
                    ...
                    setInterval(function () {
                        var rowIndex = getRandom(data.length - 1);
